...
const Controls = () => {
  ...
  useFrame((_, delta) => {
    ...
    // Reduce rotation speed by 30% for mobile controls to prevent overly sensitive turning
    const mobileRotationMultiplier = mobileSpeedMultiplier > 0.1 ? 0.7 : 1.0; // 30% reduction for mobile
