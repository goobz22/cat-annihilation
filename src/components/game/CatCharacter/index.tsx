...
const Controls = () => {
  ...
  useFrame((_, delta) => {
    ...
    // Reduce rotation speed by 75% for mobile controls to prevent overly sensitive turning
    const mobileRotationMultiplier = mobileSpeedMultiplier > 0.1 ? 0.25 : 1.0; // 75% reduction for mobile
